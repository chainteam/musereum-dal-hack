          ...
          el-row(:gutter='20' v-if='currentStep === 3')
            el-col(:span='20' :offset='2' style='padding: 120px 60px; background-color: #efece1')
              div(style='font-family: "CMU Serif", monospace')
                h3 {{ idea.name }} SALE AGREEMENT FOR FUTURE TOKENS (Second Round, Pre-Sale) 
                p 
                  span
                  ...
                  ol
                    ...
                    li 
                      ...
                      ol
                        li 
                          ...
                          strong {{ icoAmount * idea.ico.price }}
                          span 
                          | = 
                          strong {{ idea.ico.price }} 
                          span
                          | * 
                          strong {{ icoAmount }}
                        ...
                        li Buyer agrees and acknowledges that s/he/it has had an opportunity to review/discuss the functionality of the Token and has read and understood {{ idea.name }}’s materials describing the company and the Token.
                        li
                          strong {{ idea.name }}  
                        ...
                        li 
                          ...
                          ol
                            li ownership rights in {{ idea.name }}
                        ...
                        li Upon closing of the Initial Token Sale, {{ idea.name }} shall automatically issue to Buyer in exchange for the Pre-Sale Right a number of Tokens equal to: (1) the Purchase Amount divided by the Round Rate plus (2) a number of Tokens equal to the Bonus.
                        ...
                        li Buyer agrees and acknowledges that the purchase of the Pre-Sale Right is final and the Purchase Amount is non-refundable, except that if the Initial Token Sale fails to achieve a minimum sale of Tokens set by {{ idea.name }}, then {{ idea.name }} may refund some portion of the Purchase Amount to Buyer under the terms set forth regarding Dissolution Events in Section 3 of this agreement. 
                        li Buyer agrees to execute and deliver to {{ idea.name }} all transaction documents related to the Initial Token Sale. 
                        li All deliveries of Tokens shall be made directly to the crypto-wallet designated by Buyer. 
                        li If Buyer purchases its Pre-Sale Right using a third party processer, that payment processer is Buyer’s agent, not {{ idea.name }}’s, for the purpose of payment and purchase. {{ idea.name }} is not responsible for any loss of funds due to the use of a third party processer. 
                    li
                      strong Termination and Dissolution. 
                      p
                        strong a. 
                        span If there is a Dissolution Event of {{ idea.name }} before this agreement expires or terminates, {{ idea.name }} shall pay Buyer an amount equal to the Purchase Amount, due and payable to Buyer immediately prior to, or concurrent with the Dissolution Event. The Purchase Amount will be paid prior and in preference to any distribution of assets of {{ idea.name }} to equity holders in {{ idea.name }}. If immediately prior to the consummation of a Dissolution Event, the assets of {{ idea.name }} legally available for distribution to Buyer and all other holders of Pre- Sale Rights (the “Pre-Sale Right Holders”), as determined in good faith by {{ idea.name }}’s board of directors, are insufficient to permit payment to the Pre-Sale 
                      p
                        span Right Holders of their respective Purchase Amounts, then the entire assets of {{ idea.name }} legally available for distribution will be distributed with equal priority and pro rata among the Pre-Sale Right Holders in proportion to the Purchase Amounts they would otherwise be entitled to receive under this Section 3(a). 
                      p
                        strong b.
                        span This agreement will expire and terminate (without relieving {{ idea.name }} of any obligations arising from a prior breach of or non-compliance with this agreement) upon either: 
                        ul
                    ...
                    li 
                      ...
                      ul
                        ...
                        li The execution, delivery and performance by {{ idea.name }} of this agreement is within its power and has been duly authorized by all necessary actions of {{ idea.name }}. This agreement constitutes a valid, legal and binding obligation of {{ idea.name }}, enforceable against it in accordance with its terms, except as limited by bankruptcy, insolvency, or other laws of general application to or affecting the enforcement of creditors’ rights generally and general principles of equity.
                        li To the knowledge of the officers of {{ idea.name }}, the company is not in violation of (i) its current articles of incorporation, (ii) any material statute, rule or regulation applicable to it, or (iii) any material indenture or contract to which {{ idea.name }} is a party or by which it is bound, where, in each case, such violation or default, individually, or together with all such violations or defaults, could reasonably be expected to have a material adverse effect on {{ idea.name }}.
                        li The performance and consummation of the transactions contemplated by this agreement do not and will not: (i) violate any material judgment, statute, rule or regulation applicable to {{ idea.name }}, (ii) result in the acceleration of any material indenture or contract to which {{ idea.name }} is a party or by which it is bound, or (iv) result in the creation or imposition of any lien upon any property, asset, or revenue of {{ idea.name }} or the suspension, forfeiture, or nonrenewal of any material permit, license or authorization applicable to {{ idea.name }}, its business or operations. 
                        li No consents or approvals are required in connection with the performance of this agreement other than, (i) {{ idea.name }}’s corporate approvals, and (ii) any qualifications or filings under applicable law.
                        li To the knowledge of its officers, {{ idea.name }} owns or possesses (or can obtain on commercially reasonably terms) sufficient legal rights to all patents, trademarks, service marks, trade names, copyrights, trade secrets, licenses, information, processes and other intellectual property rights necessary for its business as now conducted and as currently proposed to be conducted, without any conflict with or infringement of the rights of others. 
                    li 
                      ...
                      ul
                        ...
                        li Buyer is purchasing its Pre-Sale Rights for its own personal use and utility and to participate in the {{ idea.name }} network and not for investment or financial purposes. Buyer agrees that its Pre-Sale Rights and the Token are not securities and acknowledges that the Pre-Sale Rights may lose value. 
                        ...
                        li Buyer does not intend to hinder, delay or defraud {{ idea.name }} or any other holders of Pre-Sale Rights or Tokens or engage in any illegal conduct and or unlawful activity in relation to money laundering, receiving the proceeds of drug trafficking or terrorist activities; receiving the proceeds of criminal activities, terrorist activities or trading with such countries as might from time to time be subject to any embargo imposed by the Security Council of the United Nations, or the European Union, or the United States, or in any place of the world. 
                        li Buyer will not assign this agreement (including by operation of law or by merger) or sell, delegate or sublicense of its Pre-Sale Rights under this agreement, without {{ idea.name }} prior written consent. Any such assignment, sale, delegation or sublicense shall be void. 
                    li 
                      ...
                      span Buyer shall provide {{ idea.name }} with any information it reasonably requests to determine whether {{ idea.name }} 
                      span is obligated to collect taxes from Buyer. Buyer will defend, indemnify and holds harmless {{ idea.name }}, 
                    ...
                    li 
                      ...
                      ul
                        li
                          ...
                          span identifying credentials, {{ idea.name }} may, in its sole discretion, an only if it is able, grant access to 
                          span Buyer’s account to any person providing additional credentials to us. {{ idea.name }} reserves the right to 
                        ...
                        li
                          span Buyer will provide to {{ idea.name }} upon its request information that it deems necessary to maintain 
                          span compliance with any federal, state, local, domestic or foreign law, regulation or policy. 
                        li {{ idea.name }} may use aggregate statistical information about Buyer’s activity on the {{ idea.name }} platform for marketing or any other purpose. {{ idea.name }} may use Buyer’s internet protocol address to verify Buyer’s purchase of the Pre-Sale Rights and Tokens. However, {{ idea.name }} will not release Buyer’s personal information to any third party without its consent, except as not prohibited by law or as set forth in this agreement or its privacy policy. 
                    li 
                      strong Disclaimers; Limitation of Liability. 
                      ul
                        li THE PRE-SALE RIGHTS, THE TOKENS AND THE {{ idea.name }} ARE PROVIDED “AS IS”. IMPACTPPA AND ITS AFFILIATES MAKE NO REPRESENTATIONS OF ANY KIND, EXPRESS, IMPLIED, STATUTORY OR OTHERWISE REGARDING THE PRE-SALE RIGHTS, THE TOKENS OR THE {{ idea.name }} PLATFORM INCLUDING ANY WARRANTY THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR FREE OR FREE OF HARMFUL COMPONENTS OR THAT ANY CONTENT WILL BE SECURE OR NOT OTHERWISE LOST OR DAMAGED. EXCEPT TO THE EXTENT PROHIBITED BY LAW, {{ idea.name }} AND ITS AFFILIATES DISCLAIM ALL WARRANTIES, INCLUDING WITHOUT LIMITATION IMPLIED WARRANTIES OF MERCHANTABILITY, SATISFACTORY QUALITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR QUIET ENJOYMENT, AND ANY WARRANTIES ARISING OUT OF ANY COURSE OF DEALING OR USAGE OF GRADE. {{ idea.name }} DOES NOT AND WILL NOT PROVIDE BUYER WITH ANY SOFTWARE OTHER THAN THE TOKENS. BUYER UNDERSTANDS THAT {{ idea.name }}, BLOCKCHAIN TECHNOLOGY AND PROTOCOL AND TOKENS ARE NEW AND UNTESTED TECHNOLOGY OUTSIDE OR {{ idea.name }}’S CONTROL AND ADVERSE CHANGES IN MARKET FORCES OR TECHNOLOGY WILL EXCUSE OUR PERFORMANCE UNDER THIS AGREEMENT. BUYER ASSUMES ALL RISK OF LOSS RESULTING FROM, CONCERNING OR ASSOCIATED WITH THE RISKS SET FORTH IN EXHIBIT 1 TO THIS AGREEMENT WHICH ARE HEREBY INCORPORATED BY REFERENCE INTO THIS AGREEMENT. TRANSACTIONS USING BLOCKCHAIN TECHNOLOGY, SUCH AS THOSE INVOLVING THE PRE-SALE RIGHTS, ARE AT RISK TO MULTIPLE POTENTIAL FAILURES INCLUDING HIGH NETWORK VOLUME, COMPUTER FAILURE, BLOCKCHAIN FAILURE OF ANY KIND AND USER FAILURE. 
                        li {{ idea.name }} and its affiliates will not be liable to Buyer for any direct, indirect, special, consequential or exemplary damages (including without limitation any damages for loss of profits, goodwill, use or data), even if {{ idea.name }} has been advised of the possibility of such damages. Neither {{ idea.name }} nor its affiliates will be responsible for any compensation, reimbursement or damages arising in connection with: (i) Buyer’s ability to use {{ idea.name }}’s platform, (ii) the cost of procurement of substitute goods or services, (iii) Buyer’s investments, expenditures or commitments in connection with this agreement or its use of the {{ idea.name }} platform, or (iv) any unauthorized access to, alternation of, deletion, destruction, damage or loss or failure to store any data, including without limitation any records, private key or other creditors. In any case, {{ idea.name }}’s and its affiliates aggravate liability under this agreement will be limited in value (in United States dollars at the time of the pre-sale) Buyer paid to it for its pre-sale rights. Buyer waives its right to demand the return of any Purchase Amount paid to {{ idea.name }} in the Pre-sale under any circumstance, including a demand for specific performance. 
                    li
                      ...
                      ul
                        ...
                        li This agreement and all transactions hereunder shall be governed by and construed in accordance with the internal laws of The Residence of founders of {{ idea.name }} without regard to the conflicts of law provisions. The parties consent to venue and jurisdiction of the courts situated in or having jurisdiction over The Residence of founders of {{ idea.name }}. 
